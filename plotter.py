...
def main():
    ...
    iris_df.columns = ['sepal_width', 'sepal_length',
                       ...
                       'species']
    measurement_names = ['sepal_length', 'sepal_width',
                         'petal_width', 'petal_length']
    ...
    for species in set(iris_df['species']):
        ...
        ax_scat.scatter(mask['petal_length'], mask['petal_width'],
                        label=species, alpha=.5)
    ...
    for species in set(iris_df['species']):
        mask = iris_df[iris_df['species'] == species]
        axes[1].scatter(mask['petal_length'], mask['petal_width'],
                        label=species, alpha=.5)
